...
export default function ReviewRevision() {
    ...
    if (approved) return (
        <AgentLayout>
            <div className="flex flex-col items-center justify-center py-20 text-center max-w-md mx-auto">
                ...
                <h2 className="text-white font-bold text-2xl mb-3">Revision Approved!</h2>
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full">
                    <button
                        onClick={() => navigate(`/agent/review-work/${applicationId}`)}
    ...
    if (rejected) return (
        <AgentLayout>
            <div className="flex flex-col items-center justify-center py-20 text-center max-w-md mx-auto">
                ...
                <h2 className="text-white font-bold text-2xl mb-3">Another Revision Requested</h2>
                <p className="text-sm mb-4" style={{ color: "#B2B2D2" }}>
                    Your feedback has been sent to the teenlancer.
                </p>
                <div className="p-4 rounded-2xl w-full mb-8 text-left"
                    style={{ background: "rgba(248,113,113,0.06)", border: "1px solid rgba(248,113,113,0.2)" }}>
                    <p className="text-xs font-semibold mb-2" style={{ color: "#f87171" }}>Your Feedback</p>
    ...
    return (
        <AgentLayout>
            <p className="text-xs mb-6" style={{ color: "#B2B2D2" }}>
                ...
                {" › "}
                <span style={{ color: "#FFC085" }}>Review Revision</span>
            </p>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h1 className="text-white font-bold text-2xl">Review Revised Work</h1>
                        <p className="text-sm" style={{ color: "#B2B2D2" }}>
                            The teenlancer has submitted their revision for your review.
                        </p>
                    </div>
                </div>
                ...
                {submission ? (
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="p-5 rounded-2xl"
                            style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                            <h3 className="text-white font-semibold mb-3">What Was Changed</h3>
                        ...
                        <div className="p-4 rounded-xl flex gap-3"
                            ...
                            <div>
                                ...
                                <p className="text-xs" style={{ color: "#B2B2D2" }}>
                                    Payment is securely held by Gengig. Approving this revision will release the payment immediately.
                                </p>
                            </div>
                        </div>
                        ...
                        {showRejectForm && (
                            <div className="p-5 rounded-2xl"
                                ...
                                <h3 className="font-semibold mb-3 text-sm" style={{ color: "#f87171" }}>
                                ...
                                <button onClick={handleApprove} disabled={approving}
                                    ...
                                    {approving ? (
                                        <><div className="w-4 h-4 rounded-full border-2 animate-spin"
                                            ...
                                            Approving...</>
                                    ) : "✓ Approve Revision & Release Payment"}
                                </button>
                                <button onClick={() => setShowRejectForm(true)}
                                    className="flex-1 py-3 rounded-full font-semibold hover:opacity-90"
                                    style={{
                    ...
                    <div className="flex flex-col items-center justify-center py-20 rounded-2xl"
                        ...
                        <p className="text-white font-medium mb-1">No revision submitted yet</p>
                        <p className="text-sm" style={{ color: "#B2B2D2" }}>
                            The teenlancer hasn't submitted their revision yet.
                        </p>
                    </div>
                )}
            </div>
