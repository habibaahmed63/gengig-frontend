...
export default function ApplyGig() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.message.trim()) {
            setError("Please write an intro message.");
            return;
        }
        if (formData.message.trim().length < 20) {
            setError("Your intro message must be at least 20 characters.");
            return;
        }
        ...
        if (!formData.timeline) {
            setError("Please select a delivery timeline.");
            return;
        }
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    {gig?.budget && (
                                        <p className="text-xs" style={{ color: "#B2B2D2" }}>
                                            Agent's budget: <span style={{ color: "#FFC085" }}>{gig.budget}</span>
                                        </p>
                                    )}
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {gig?.deadline && (
                                        <p className="text-xs" style={{ color: "#B2B2D2" }}>
                                            Agent's deadline: <span style={{ color: "#FFC085" }}>{gig.deadline}</span>
                                        </p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {fileName && (
                                    <button
                                        ...
                                        className="text-xs self-start hover:opacity-80 transition-opacity"
                                        style={{ color: "#f87171" }}>
                                        Remove file
                                    </button>
                                )}
                                ...
                                {gig.agent && (
                                    <div className="flex items-center gap-3 mb-4 pb-4"
                                        ...
                                        <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0"
                                            ...
                                            {gig.agent.img ? (
                                                <img src={gig.agent.img} alt={gig.agent.name}
                                                    className="w-full h-full object-cover" />
                                            ) : (
                                                <span className="font-bold text-sm" style={{ color: "#FFC085" }}>
                                                    {gig.agent.name?.charAt(0) || "?"}
                                                </span>
                                            )}
                                        </div>
                                        <div>
