            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-20 lg:py-10">
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-sm flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                            <input type={showConfirm ? "text" : "password"} name="confirmPassword" value={formData.confirmPassword} onChange={handleChange}
                                className="w-full rounded-md px-3 py-2 pr-10 text-white text-sm outline-none focus:ring-1 focus:ring-[#FFC085]"
                                style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.1)" }} />
                            <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#B2B2D2] hover:text-white transition-colors">
                                {showConfirm ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    ...
                    <button type="submit" disabled={loading}
                        className="w-full py-2.5 rounded-full font-semibold text-white mt-2 transition-opacity hover:opacity-90 disabled:opacity-50"
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <button type="button" onClick={handleGoogleSignUp}
                            ...
                            className="w-9 h-9 rounded-full bg-white flex items-center justify-center hover:scale-105 hover:shadow-lg transition-all">
                        ...
                        {/* Apple */}
                        <button type="button" onClick={handleAppleSignUp}
                            title="Sign up with Apple"
                            className="w-9 h-9 rounded-full bg-black border border-white/20 flex items-center justify-center hover:scale-105 hover:shadow-lg transition-all">
                        ...
                        <button type="button" onClick={handleFacebookSignUp}
                            ...
                            className="w-9 h-9 rounded-full flex items-center justify-center hover:scale-105 hover:shadow-lg transition-all" style={{ background: "#1877F2" }}>
                            <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
