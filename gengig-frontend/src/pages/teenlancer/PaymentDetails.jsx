...
export default function TeenlancerPayment() {
  ...
  useEffect(() => {
    const fetchPaymentData = async () => {
      // Load card from localStorage (persists until backend ready)
      ...
      try {
        ...
        // setTotalEarnings(statsRes.data.totalEarnings);
        ...
        {[
          {
            ...
            desc: "Updated from completed gigs",
          },
          {
            label: "Pending Payments",
            value: statsLoading ? "..." : pendingPayments,
      ...
      {(showCardForm || !savedCard) && (
        <div className="p-6 rounded-2xl mb-8" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="flex items-center justify-between mb-6">
            ...
            {savedCard && (
              <button onClick={() => setShowCardForm(false)} className="text-xs hover:opacity-80 transition-opacity" style={{ color: "#B2B2D2" }}>
                Cancel
              </button>
            )}
          </div>
      ...
      <div className="rounded-2xl overflow-hidden" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        {historyLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <p className="text-xs" style={{ color: "rgba(178,178,210,0.4)" }}>Payments will appear here once you complete gigs.</p>
          </div>
        )}
      </div>
    </TeenlancerLayout>
