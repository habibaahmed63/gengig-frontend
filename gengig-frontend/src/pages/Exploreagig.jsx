...
const recommended = [
    { title: "Trendify Studio", category: "Graphic Design", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400" },
    { title: "App Rush", category: "Tech & UX", img: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=400" },
    { title: "Vibe Now", category: "Video Editing", img: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=400" },
];
...
const tips = [
    ...
    { title: "Show Progress Don't Panic", desc: "If something goes wrong, update the client early. Clients appreciate honesty and effort over silence and last-minute excuses.", img: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400" },
];
    ...
    return (
        <div style={{ background: "#060834" }}>
            ...
            <section className="py-10 md:py-12 px-6 md:px-8 flex flex-col items-center text-center">
                ...
                <div className="mt-6 w-full max-w-md flex items-center gap-2 rounded-full px-4 py-2.5" style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)" }}>
                    ...
                    <button className="text-[#FFC085] hover:opacity-80 transition-opacity"
                    ...
                    <div className="flex gap-4 items-end">
                        {categories.map((cat, i) => (
                            <div
                                ...
                                style={{ transform: i === activeCategory ? "scale(1.15)" : "scale(0.9)", opacity: i === activeCategory ? 1 : 0.6 }}
                            >
                                <img
                                    src={cat.img}
                                    alt={cat.label}
                                    className="rounded-xl object-cover"
                                    style={{ width: i === activeCategory ? "160px" : "100px", height: i === activeCategory ? "200px" : "140px" }}
                                />
            ...
            <section className="py-10 md:py-12 px-6 md:px-8 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    {recommended.map((gig) => (
                        <div key={gig.title} className="relative rounded-2xl overflow-hidden group cursor-pointer">
                            <img src={gig.img} alt={gig.title} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" />
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between">
                                ...
                                <button className="w-7 h-7 rounded-full flex items-center justify-center" style={{ background: "#FFC085" }}>
            ...
            <section className="py-10 md:py-12 px-6 md:px-8 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
                    {tips.map((tip) => (
                        <div key={tip.title} className="relative rounded-2xl overflow-hidden flex flex-col justify-end" style={{ height: "320px" }}>
            ...
            <section className="mx-4 md:mx-8 my-12 rounded-2xl overflow-hidden relative" style={{ minHeight: "200px" }}>
                <img src="https://images.unsplash.com/photo-1522163182402-834f871fd851?w=1200" alt="newsletter" className="absolute inset-0 w-full h-full object-cover" />
                ...
                <div className="relative z-10 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 max-w-sm">
                        ...
                        />
                        <button className="px-5 py-2 rounded-full text-sm font-semibold text-white transition-opacity hover:opacity-90" style={{ background: "linear-gradient(90deg, #FFC085, #e8a060)" }}>
                            Subscribe
                        </button>
                    </div>
                </div>
