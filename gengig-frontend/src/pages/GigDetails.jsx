...
export default function GigDetails() {
    ...
    const handleApply = () => {
        ...
        if (requireRole("teenlancer")) return;
                ...
                <div className="max-w-6xl mx-auto px-6 md:px-8 py-8">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="flex-1 flex flex-col gap-6">
                            ...
                            <div className="p-6 rounded-2xl" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                                <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                                    <div>
                                        ...
                                        <h1 className="text-white font-bold mt-2" style={{ fontSize: "clamp(1.3rem, 3vw, 2rem)" }}>{gig.title}</h1>
                                    </div>
                                    <button onClick={handleSave} className="p-2 rounded-full transition-colors"
                            ...
                            {gig.description && (
                                <div className="p-6 rounded-2xl" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                                    ...
                                    <p className="text-sm leading-relaxed whitespace-pre-line" style={{ color: "#B2B2D2" }}>{gig.description}</p>
                                </div>
                            )}
                        ...
                        <div className="w-full lg:w-80 flex flex-col gap-6 flex-shrink-0">
                            <div className="p-6 rounded-2xl sticky top-28"
                                ...
                                <button onClick={handleApply}
                                    ...
                                    style={{ background: "linear-gradient(90deg, #FFC085, #e8a060)" }}>
                                    {role === "agent" ? "Agents Cannot Apply" : "Apply Now →"}
                                </button>

                                {role === "agent" && (
                                    <p className="text-xs text-center mt-2" style={{ color: "rgba(178,178,210,0.5)" }}>
                                        Switch to a teenlancer account to apply
                                    </p>
                                )}
                    ...
                    {relatedGigs.length > 0 && (
                        <div className="mt-12">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                {relatedGigs.map(g => (
                                    <Link key={g._id || g.id} to={"/gig/" + (g._id || g.id)}
