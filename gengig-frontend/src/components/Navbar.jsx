      ...
      <div className="fixed top-3 left-1/2 -translate-x-1/2 z-50 w-[100%] max-w-6xl">
            ...
            {token ? (
              <>
                ...
                <button
                  ...
                  className="px-4 py-1.5 rounded-full text-sm font-semibold border hover:bg-white/10 transition-colors"
                ...
                <Link to="/notifications" className="relative text-[#B2B2D2] hover:text-white transition-colors">
                  ...
                  <span className="absolute -top-1 -right-1 w-3.5 h-3.5 rounded-full text-xs flex items-center justify-center font-bold" style={{ background: "#FFC085", color: "#060834", fontSize: "8px" }}>
                    3
                  </span>
                </Link>
                <button
                ...
                >
                  <img src="../src/assets/profile.jpg" alt="avatar" className="w-full h-full object-cover" />
                </button>
              </>
            ) : (
              <>
                ...
                {/* Profile icon */}
                <Link to="/signin" className="text-[#B2B2D2] hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {menuOpen && (
          ...
          >
            ...
            {token ? (
              <>
                <button onClick={handleDashboard} className="text-sm font-medium text-left py-2 transition-colors hover:text-[#FFC085]" style={{ color: "#B2B2D2" }}>
                  Dashboard
                </button>
              ...
              <>
                <Link to="/signin" onClick={() => setMenuOpen(false)} className="text-sm font-medium py-2" style={{ color: "white" }}>
                  Login
                </Link>
                <Link to="/signup" onClick={() => setMenuOpen(false)} className="px-4 py-2 rounded-full text-sm font-semibold text-white text-center hover:opacity-90" style={{ background: "linear-gradient(90deg, #FFC085, #e8a060)" }}>
                  Register
                </Link>
              </>
            )}
