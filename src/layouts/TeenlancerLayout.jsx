...
export default function TeenlancerLayout({ children }) {
    ...
    const navItems = [
        ...
        {
            label: "Messages", path: "/teenlancer/chat", icon: (
    ...
    const SidebarContent = ({ isCollapsed = false }) => (
        <>
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="#FFC085" strokeWidth={2}
    ...
    return (
        <div className="min-h-screen" style={{ background: "#060834" }}>
            ...
            <div className="flex relative">
                ...
                >
                    <button className="self-end mb-6 text-white hover:text-[#FFC085]" onClick={() => setSidebarOpen(false)}>✕</button>
                ...
                <main className="flex-1 p-4 md:p-8 overflow-x-hidden">                    {children}
